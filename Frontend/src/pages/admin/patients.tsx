                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-3">
                  ...
                  <li>
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-500">{dictionary.dashboard.patients}</span>
                    </div>
                  </li>
                </ol>
              </nav>
            </div>
            <h1 className="text-2xl font-semibold text-gray-800 mb-6">{dictionary.dashboard.patients}</h1>
